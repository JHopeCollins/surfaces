...
//    const int      npts = nCircle*( nBranch + nPlane );
      const int      npts = nCircle*( nBranch + nPlane + nFillet );
...
//    const int      nTest = nCircleTest*( nBranchTest + nPlaneTest );
      const int      nTest = nCircleTest*( nBranchTest + nPlaneTest + nFilletTest );
   ...
   // write points to file
     {
      ...
      for( i=0; i<nTest; i++ )
     {
         ofileTest << xt2[i][0] << " " << xt2[i][1] << " " << xt2[i][2] << " " << isurf.F( xt2[i] ) << std::endl;
     }

      for( i=0; i<npts; i++ )
     {
         ofile << x2[i][0] << " " << x2[i][1] << " " << x2[i][2] << " " << isurf.F( x2[i] ) << std::endl;
     }
